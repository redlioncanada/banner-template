$(function() {
    ...
    if ("160x600" in mainBannerCopy) {
        mainBannerCopy = mainBannerCopy["160x600"];
    } else {
    ...
    function playEndFrame(){
        ...
        var delay = 3;
        TweenMax.to(yellowBar,1, {top: 600+600*0.3, ease:Elastic.easeOut.config(1, 0.5), delay:delay});
        TweenMax.to(copyContainer,1, {top: 600+600*0.3, ease:Elastic.easeOut.config(1, 0.5), delay:delay});
