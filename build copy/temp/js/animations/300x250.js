$(function() {
    ...
    if ("300x250" in mainBannerCopy) {
        mainBannerCopy = mainBannerCopy["300x250"];
    } else {
    ...
    function playEndFrame(){
        ...
        var delay = 3;
        TweenMax.to(yellowBar,1, {top: 250+250*0.3, ease:Elastic.easeOut.config(1, 0.5), delay:delay});
        TweenMax.to(copyContainer,1, {top: 250+250*0.3, ease:Elastic.easeOut.config(1, 0.5), delay:delay});
