$(function() {
    ...
    if ("728x90" in mainBannerCopy) {
        mainBannerCopy = mainBannerCopy["728x90"];
    } else {
    ...
    function playEndFrame(){
        ...
        var delay = 3;
        TweenMax.to(yellowBar,1, {top: 90+90*0.3, ease:Elastic.easeOut.config(1, 0.5), delay:delay});
        TweenMax.to(copyContainer,1, {top: 90+90*0.3, ease:Elastic.easeOut.config(1, 0.5), delay:delay});
