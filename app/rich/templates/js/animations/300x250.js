...
var timeline = new TimelineLite({onComplete: onComplete});
        timeline.add('frame1')
            ...
            .to('.masks .m4', 0.8, {width:194,left:105}, 'frame1-m2').add('frame1-m4')
        ...
        timeline.add('f2-transition')
            ...
            .to('.background-container', 1, {left:0, width:272, height:128, top:-10}, 'f2-transition')
            .to('.background-container img', 1, {top:-71}, 'f2-transition')
            .to('.copy1,.mask.m5,.masks', 0, {opacity: 0})
        timeline.add('frame2')
            .to('.copy3', 0.3, {opacity:1})
