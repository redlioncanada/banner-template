...
var timeline = new TimelineLite({onComplete: onComplete});
        timeline.add('frame1').add('start')
            .to('#copy1 span, #copy1-prefix span, #copy1 .highlight', 0.8, {opacity:1, ease:easeIn}).add('copy1-prefix')
            .addDelay(2, 'frame2');
        timeline.add('frame2')
            .to('#copy1,#copy1-prefix', 0.8, {opacity:0, ease:easeOut})
            .to('#copy2-prefix span', 0.8, {opacity:1, ease:easeIn})
            .addDelay(1.5, 'copy2-prefix')
            .to('#copy2 span, #copy2-prefix span, #copy2 .highlight', 0.8, {opacity:1, ease:easeIn}).add('copy2-prefix')
            .addDelay(2.5, 'frame3');
        timeline.add('frame3')
